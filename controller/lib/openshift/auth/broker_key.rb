  ...
  module Auth
    ...
    class BrokerKey
      ...
      def authenticate_request(request)
        key, iv = request.request_parameters.values_at('broker_auth_key', 'broker_auth_iv')
        validate_broker_key(key, iv) if key && iv
      end
      ...
      def validate_broker_key(iv, key)
        ...
        begin
          ...
          #$stderr.puts e.message   # now logs to rails
          #$stderr.puts e.backtrace # now logs to rails
