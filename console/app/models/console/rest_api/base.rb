...
module RestApi
  ...
  class OpenshiftJsonFormat
    ...
    def mime_type
      "application/json;nolinks;version=#{API_VERSION}"
    end
  end
  ...
  class Base < ActiveResource::Base
    ...
    def load_remote_errors(remote_errors, save_cache=false, optional=false)
      begin
        ...
        raise BadServerResponseError, msg, $@ unless optional
      end
    ...
    def self.as_attribute_hash
      AttributeHash
    end
    has_many :messages, :class_name => as_attribute_hash
    ...
    class << self
      ...
      private
        def update_connection(connection)
          ...
          connection.debug_output = $stderr if Console::RestApi.debug?
          connection
        end
